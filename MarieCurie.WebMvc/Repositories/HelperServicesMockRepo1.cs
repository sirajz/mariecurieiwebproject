...
namespace MarieCurie.WebMvc.Repositories
{
    public class HelperServicesMockRepo1 : IHelperServiceRepository
    {
        public List<MyHelperService> getCenters()
        {
            ...
            List<int> MonType2 = new List<int> { 17, 23 };
            List<int> TueType2 = new List<int> { 17, 23 };
            List<int> WedType2 = new List<int> { 17, 23 };
            List<int> ThuType2 = new List<int> { 17, 23 };
            List<int> FriType2 = new List<int> { 17, 23 };
            List<int> SatType2 = new List<int> { 17, 23 };
            List<int> SunType2 = new List<int> { 17, 23 };
